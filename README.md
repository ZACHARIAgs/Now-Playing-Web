...
⚡️ **Old-Device Optimized:** The animations are heavily optimized using GPU hardware acceleration (`translate3d`), meaning it runs flawlessly and respects battery life even on extremely old hardware.  
